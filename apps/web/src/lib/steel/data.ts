...
export const STEEL_FORMS: SteelForm[] = [
  ...
  },
  {
    ...
    filters: {
      ...
      oberflaeche:     ["Blank","Schwarz (warmgewalzt)","Gebeizt & passiviert"],
      laenge:          ["1.000 mm","2.000 mm","3.000 mm","4.000 mm","6.000 mm","Zuschnitt"],
      staerke:         ["6 mm","8 mm","10 mm","12 mm","15 mm","16 mm","20 mm","25 mm","30 mm","40 mm","50 mm","60 mm","80 mm"],
      toleranz:        ["h9","h11","IT16"],
    },
    products: [
      { id:"vier-01", name:"Blankstahl Vierkant",    form:"vierkantprofile", werkstoffe:["S235JR","E335","C45","11SMn30"], herstellungsart:["Gezogen"],    oberflaechenList:["Blank"],                    laengenMm:[1000,2000,3000,4000,6000], staerkenMm:[6,8,10,12,15,16,20,25,30,40,50,60,80], toleranz:["h9","h11"], beschreibung:"Kaltgezogener Vierkant-Blankstahl nach EN 10277. Präzise Kantengeometrie." },
      { id:"vier-02", name:"Edelstahl Vierkant",     form:"vierkantprofile", werkstoffe:["1.4301 (304)","1.4404 (316L)"], herstellungsart:["Gezogen"], oberflaechenList:["Gebeizt & passiviert","Blank"], laengenMm:[1000,2000,3000,4000,6000], staerkenMm:[8,10,12,16,20,25,30,40,50], toleranz:["h9","h11","IT16"], beschreibung:"Nichtrostender Edelstahl-Vierkant nach EN 10088-3." },
      { id:"vier-03", name:"Werkzeugstahl Vierkant", form:"vierkantprofile", werkstoffe:["1.2312"],                      herstellungsart:["Gezogen"],    oberflaechenList:["Blank"],                    laengenMm:[1000,2000,3000], staerkenMm:[10,12,16,20,25,30,40,50], toleranz:["h9"], beschreibung:"Werkzeugstahl für Stempel und Schnittplatten." },
    ],
  },
  {
