...
interface NavItem {
  label:       string;
  href:        string;
  /** If set, link is active when pathname starts with this prefix */
  activePrefix?: string;
    ...
    >
      ...
      {hovered && me && (
        <div style={{
          ...
          {/* Name + role */}
          <p style={{ margin: "0 0 6px", fontSize: 13, fontWeight: 700, color: DARK, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
            {dispName}
          </p>
          ...
          <div style={{ marginTop: 12, paddingTop: 12, borderTop: `1px solid #f0f2f5`, display: "flex", flexDirection: "column", gap: 6 }}>
            {[
              ...
              <a key={href} href={href}
                style={{ fontSize: 12, color: MUTED, textDecoration: "none", display: "block" }}
...
export function EucxHeader() {
  ...
  function isActive(item: NavItem): boolean {
    ...
    if (item.activePrefix) {
      // "Übersicht" should only be active on the exact buyer dashboard, not on sub-routes
      if (item.href === "/dashboard/buyer" && item.activePrefix === "/dashboard/buyer") {
        return pathname === "/dashboard/buyer";
      }
      if (item.href === "/dashboard/seller" && item.activePrefix === "/dashboard/seller") {
    ...
    <div style={{ position: "sticky", top: 0, zIndex: 50, fontFamily: F }}>
      ...
      <div style={{ backgroundColor: "#1a1a1a", height: 36 }}>
        <div style={{
          ...
          {/* Right: market status + lang + logout */}
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Logo — fixed left */}
          <a href="/" style={{ textDecoration: "none", flexShrink: 0, marginRight: 28 }}>
            <EucxLogo size="sm" />
          </a>
          ...
          <nav style={{
            ...
            height: 56, overflowX: "auto", overflowY: "hidden",
            scrollbarWidth: "none",
          }}>
            {navItems.map((item) => (
          ...
          {/* Right: Bell + Shield + Divider + Avatar */}
