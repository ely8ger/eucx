          ...
          <div className="flex items-start justify-between mb-4">
            <div>
              <div className="flex items-center gap-3 mb-1">
                <h1 className="text-xl font-bold text-gray-900">Betonstahl A1 · Ø12mm · B500B</h1>
      ...
      <Tabs defaultValue="trading">
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="border-gray-100 hover:bg-transparent">
                      ...
                      <TableHead className="text-xs text-gray-400 font-semibold uppercase tracking-wider text-right">Preis €/t</TableHead>
                      <TableHead className="text-xs text-gray-400 font-semibold uppercase tracking-wider text-right">Menge</TableHead>
                      <TableHead className="text-xs text-gray-400 font-semibold uppercase tracking-wider">Zeit</TableHead>
                    ...
                    {SELL.map((o) => (
                      ...
                      >
                        <TableCell className="pl-0">
                          ...
                          {o.mine && <span className="ml-1.5 text-[10px] font-bold text-[#154194] bg-blue-100 px-1.5 py-0.5 rounded">MEIN</span>}
                        </TableCell>
                        <TableCell className="text-right">
                          <span className="text-sm font-bold font-mono text-red-500">{o.price.toLocaleString("de-DE")}</span>
                        </TableCell>
                        <TableCell className="text-right">
                        ...
                        <TableCell className="pr-0 text-right">
                          {!o.mine && (
                            <button className="text-xs text-[#154194] hover:text-[#0E2D6B] font-semibold">Kaufen</button>
                          )}
                        </TableCell>
                      </TableRow>
                    ))}
                  ...
                  <TableBody>
                    {BUY.map((o) => (
                      ...
                      >
                        ...
                        <TableCell className="text-right">
                          <span className="text-sm font-bold font-mono text-emerald-600">{o.price.toLocaleString("de-DE")}</span>
                        </TableCell>
                        <TableCell className="text-right">
                          <span className="text-sm font-mono text-gray-700">{o.qty} {o.unit}</span>
                        </TableCell>
                        ...
                        <TableCell className="pr-0 text-right">
                          {!o.mine && (
                            <button className="text-xs text-[#154194] hover:text-[#0E2D6B] font-semibold">Details</button>
                          )}
                        </TableCell>
                      </TableRow>
                    ))}
          ...
          <Card className="border border-gray-100 shadow-sm">
            <CardContent className="pt-5">
              <Table>
                <TableHeader>
                  <TableRow className="border-gray-100 hover:bg-transparent">
                    {["Abschluss-Nr.", "Zeit", "Preis €/t", "Menge", "Käufer", "Verkäufer"].map((h, i) => (
                ...
                <TableBody>
                  {DEALS.map((d) => (
                    <TableRow key={d.id} className="border-gray-100 hover:bg-gray-50/50">
                      ...
                      <TableCell className="text-right font-mono font-bold text-gray-900">{d.price.toLocaleString("de-DE")}</TableCell>
        ...
        <TabsContent value="deposit" className="mt-4">
          <div className="grid grid-cols-3 gap-4">
            {[
              { label: "Gesamtkaution",    value: "€ 50.000", sub: "hinterlegt",              cls: "text-gray-900"    },
              { label: "Gesperrt",         value: "€ 14.200", sub: "durch offene Aufträge",   cls: "text-red-500"     },
              { label: "Frei verfügbar",   value: "€ 35.800", sub: "für neue Aufträge",        cls: "text-emerald-600" },
            ].map((k) => (
